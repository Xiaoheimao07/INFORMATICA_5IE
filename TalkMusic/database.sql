-- Active: 1778196427345@@127.0.0.1@3306@strumentirecensioni

CREATE DATABASE IF NOT EXISTS TalkMusicDatabase;
USE TalkMusicDatabase;
...
CREATE TABLE Articolo (
    ...
    categoria ENUM('chitarre', 'bassi', 'batterie', 'tastiere', 'archi') NOT NULL,
